...
class GerenciamentoAdministradores:
    ...
    def exibir_menu(self):
        while True:
            self.console.print(Panel("MENU PRINCIPAL", style="bold cyan", expand=False))
            ...
            match opcao:
                ...
                case "3":
                    self.console.print("[bold red]Encerrando o programa...[/bold red]")
                    break
                case _:
                    self.console.print(
    ...
    def adicionar_administrador(self):
        ...
        nome = Prompt.ask("[bold yellow]Digite o nome do Administrador[/bold yellow]")
        email = Prompt.ask("[bold yellow]Digite o email do Administrador[/bold yellow]")

        adm_id = str(uuid.uuid4().int >> 64)

        novo_administrador = Administrador(adm_id, nome, email)
        self.controller.adicionar_administrador(novo_administrador=novo_administrador)
        self.console.print(
    ...
    def listar_administradores(self):
        ...
        if administradores:
            ...
            self.console.print("[bold red]Nenhum Administrador cadastrado.[/bold red]")
